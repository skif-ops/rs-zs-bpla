...
со стороны МК в Rev.A недоступен. На построенной партии `EVT-ENV-BATT-COLD` должен
показать запрет заряда при температуре АКБ ниже 0 °C и переход MPPT на внутренний
датчик в интервале −20…−10 °C. Для серии рассматривается линия remote on/off MPPT.
