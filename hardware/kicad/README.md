...
- BLE commissioning/OTA coprocessor: `ESP32-C3-MINI-1-N4` candidate. Older nRF52832-class references are superseded.
...
1. `PCB-MAIN`: MCU, BG95, dual SIM, MAX-M10S, LoRa module, ESP32-C3, NOR, microSD, sensors, USB service, SWD and test points.
...
7. `07_BLE` - ESP32-C3-MINI-1-N4 service/commissioning/OTA coprocessor and programming access.
...
- Datasheet/reference-design review for STM32U585, T5838, BG95, MAX-M10S, E22/SX1262, ESP32-C3 and all power ICs.
...
- RF review for cellular/GNSS/LoRa 50-ohm paths, keepouts, grounding and coexistence.
