...
| PWR-FUSE-01 | `0451008.MRL` | Selected EVT qualification candidate: Nano2 451 8 A, `-55..125 C`, 7.7 mOhm nominal cold resistance and 20.23 A²s nominal melting I²t. The datasheet requires standard 25% continuous derating plus its temperature curve. Historical native value `0451005.MRL` is rejected for 5 A continuous service; the bounded value-only ECO and commit-bound ERC/PDF/human hierarchy evidence pass with topology retained. Exact fuse, TVS, header and terminal manufacturer payloads are hash-bound (`PWR-IPQ-001 PASS`), and manufacturer/supplier exact-MPN records close documentary procurement identity (`PWR-IPQ-002 PASS`) without a receiving quarantine, mandatory photos or body sampling. Physical qualification remains open. | [Littelfuse 0451008 product page](https://www.littelfuse.com/products/fuses-overcurrent-protection/fuses/surface-mount-fuses/nano-2-fuses/451/0451008), [451/453 series datasheet](https://www.littelfuse.com/assetdocs/fuse-451-and-453-datasheet?assetguid=533cd5cc-956c-4243-867f-6ab5a62f6ba1), [Molex 43045-0213](https://www.molex.com/en-us/products/part-detail/430450213) and [Molex 43030-0038](https://www.molex.com/en-us/products/part-detail/430300038) |
...
| BAT1 | RELiON `RB40` | exact EVT purchase identity: 12.8 V, 40 Ah, 512 Wh, 197 x 166 x 173 mm, M8, IP66; discharge `-20..60 C`, charge `-20..45 C`; does not by itself close station `-40..+70 C` | [RELiON RB40 product page](https://www.relionbattery.com/products/lithium/rb40); documentary purchase identity is released, while applicable transport documents at order and capacity/DCIR/BMS/cold-soak evidence during assembly/EVT remain open |
| PV1 | SLD Tech / Solarland `SLP080S-12M` | exact EVT purchase identity: 80 W, Vmp 18.46 V, Imp 4.33 A, Voc 22.52 V, Isc 4.56 A, 1475 x 342 x 40 mm, `-40..85 C` | [SLD Tech exact product page](https://sldtechinc.com/80w-12v-monocrystalline-solar-panel-s/); documentary purchase identity is released, while IV, cold-Voc, insulation and mechanical validation during assembly/EVT remain open |
| MPPT1 | Victron Energy `SCC075010060R` | exact SmartSolar MPPT 75/10 EVT purchase identity: 12/24 V, 10 A, 75 V maximum PV, 145 W nominal PV at 12 V, `-30..60 C`; IP43 electronics / IP22 terminal area | [Victron SmartSolar 75/10 technical specifications](https://www.victronenergy.com/media/pg/Manual_SmartSolar_MPPT_75-10_up_to_100-20/en/technical-specifications.html); documentary purchase identity is released, while configuration, cold enclosure, quiescent/reverse-current and transient validation during assembly/EOL/EVT remain open |
| MPPT-TEMP | Victron Energy `SBS050150200` | exact long-range Smart Battery Sense EVT purchase identity; `10 m` is wireless range, while the leads are `0.45 m`; M10 eyelets require an approved retention stack on the RB40 M8 terminals; operating range `-10..60 C`; supplies actual battery voltage/temperature over VE.Smart | [Victron temperature sensor matrix](https://www.victronenergy.com/live/temperature_sensors), [Smart Battery Sense technical specification](https://www.victronenergy.com/media/pg/Smart_Battery_Sense/en/technical-specifications.html), [product page](https://www.victronenergy.com/meters-and-sensors/smart-battery-sense) and [SmartSolar cut-off behavior](https://www.victronenergy.com/media/pg/Manual_SmartSolar_MPPT_75-10_up_to_100-20/en/configuration-and-settings.html); documentary purchase identity is released, while terminal-stack fit, pairing retention, cold-system behavior and `0 C` cut-off validation during assembly/EOL/EVT remain open |
| ANT-CELL | Taoglas `G30.B.108111` | exact EVT purchase identity: external IP67 permanent-mount cellular antenna, SMA(M), 1 m integral cable, manufacturer headline bands 698-960 and 1710-2700 MHz, `-40..85 C`; the product-page RG-316/RG-178 wording conflict is not silently resolved | [Taoglas exact product page](https://www.taoglas.com/product/olympian-g30-2g3g4g-lte-antenna/); exact MPN is purchase-controlled, ordered cable construction must be recorded on the quote, and installed S11/VSWR/loss plus coexistence remain assembly/EVT validation |
| ANT-GNSS | Taoglas `AA.166.A.301111` | exact EVT purchase identity: active L1 multi-GNSS, 1559-1610 MHz, 3-5 V, IP67, 3 m RG-174, SMA(M), `-40..85 C`; project supervisor limit is 50 mA | [Taoglas exact product page](https://www.taoglas.com/product/aa-166-a-301111-ulysses-miniature-magnetic-mount-beidougpsglonassgalileo-antenna-with-3000mm-rg-174-smam/) and [datasheet](https://www.taoglas.com/datasheets/AA.166.301111.pdf); documentary purchase identity is released, while current at 3.3 V, receiver sensitivity, PPS and coexistence remain assembly/EOL/EVT validation |
...
documentary purchase gate requires exact manufacturer MPN, a supplier catalogue or
quotation binding and `NO SUBSTITUTION`; it does not require a stand-alone pre-order
qualification unit, receiving quarantine, mandatory photographs, a fixed body count,
lot/date capture or CoC. Ordinary receipt reconciliation does not replace the open
assembly, EOL and EVT physical checks.

For every remaining candidate or pending line, current manufacturer documentation
shall be captured into the release data pack at the revision used by the design
review. Links above are evidence pointers, not permission to substitute a family
member or suffix.
