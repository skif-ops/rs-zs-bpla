...
- Количество на изделие: 1.
- Технология Rev.A: 4 медных слоя. Цель для запроса фабрике — внешние слои 2 oz,
  внутренние 1 oz; медь, диэлектрики и толщина не заморожены до DIM-003,
  токового/теплового расчёта и DFM.
