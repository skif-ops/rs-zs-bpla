...
| Manufacturer-drawing controlled patterns | 2 | Nexperia SOD962-2 geometry and source hash controlled locally |
| KiCad library patterns | 44 | Exact pad-number contract passes; drawing review remains open |
| Provisional manufacturer-specific patterns | 12 | Blocker; replace from controlled manufacturer drawing |

The controlled updates reduced the provisional set from 52 to 12 instances by
...
`FL1`, `J12`, `J13`, `J6`, `J7`, `J_PWR`, `U10`, `U4`, `U5`, `U8`, `U9`, `X1`.
...
1. all 12 provisional instances are replaced by controlled land patterns;
