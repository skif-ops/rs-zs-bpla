...
| Manufacturer-drawing controlled patterns | 4 | Nexperia SOD962-2, ST UDFN-6L and ADI DCB geometry controlled locally |
| KiCad library patterns | 44 | Exact pad-number contract passes; drawing review remains open |
| Provisional manufacturer-specific patterns | 10 | Blocker; replace from controlled manufacturer drawing |

The controlled updates reduced the provisional set from 52 to 10 instances by
...
capture manifest.
The same control now covers `U4` from ST DS12606 Rev8 Figures 10/11 and `U5`
from Analog Devices/LTC drawing 05-08-1715.

## Remaining provisional references

`FL1`, `J12`, `J13`, `J6`, `J7`, `J_PWR`, `U10`, `U8`, `U9`, `X1`.
...
1. all 10 provisional instances are replaced by controlled land patterns;
