...
- Provisional manufacturer-specific footprints: 14 instances (reduced from 52).
...
- [ ] All 14 provisional instances are replaced from controlled manufacturer drawings.
