...
- Provisional manufacturer-specific footprints: 9 instances (reduced from 52).
- Manufacturer-drawing controlled project-local footprints: 5 instances (`D3`, `D5`, `U4`, `U5`, `X1`).
...
- [ ] All 9 provisional instances are replaced from controlled manufacturer drawings.
