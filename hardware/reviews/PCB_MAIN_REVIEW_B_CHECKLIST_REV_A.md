...
- Provisional manufacturer-specific footprints: 8 instances (reduced from 52).
- Manufacturer-drawing controlled project-local footprints: 6 instances (`D3`, `D5`, `U4`, `U5`, `U9`, `X1`).
...
- [ ] All 8 provisional instances are replaced from controlled manufacturer drawings.
