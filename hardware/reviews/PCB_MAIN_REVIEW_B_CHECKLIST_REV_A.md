...
- Provisional manufacturer-specific footprints: 6 instances (reduced from 52).
- Manufacturer-drawing controlled project-local footprints: 8 instances (`D3`, `D5`, `FL1`, `U4`, `U5`, `U9`, `U10`, `X1`).
...
- [ ] All 6 provisional instances are replaced from controlled manufacturer drawings.
