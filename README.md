...
Эта ветка содержит инженерную базу предсерийного EVT с вариантами партии 4, 10 или 20 станций и резервом серийных номеров на 20.
Текущий контрольный срез: `EVT-PRE-20 Rev.A v0.3`, дата 13.09.2026.

## Зафиксированный baseline

- количество: до purchase release выбирается 4, 10 или 20 изделий; серийные номера `DIO-EVT-001`…`DIO-EVT-020` зарезервированы как максимальная ёмкость;
...
- корпус: для выбранного лота из 4, 10 или 20 изделий принято вакуумное литьё; 3D-печать является условным резервом на выбранное количество, а для ТПА готовится отдельный комплект исходных данных без изготовления пилотной оснастки;
