...
неразведённый placement-кандидат платы. Независимый clearance-аудит этого
кандидата выявил 17 подтверждённых courtyard-коллизий, 67 screening-коллизий и
шесть конфликтов внутри механически зафиксированных ограничений: две пары
компонентов, два mounting-exclusion и два U.FL tool/service clearance. Подписанный
электрический Review A сохраняется, но placement и Review B заблокированы до
ограниченного механического ECO `MAIN-AUTH-011` и полной перерасстановки. Полный native source set PCB-MIC и
