...
ограничений устранены. Независимый clearance-аудит всё ещё фиксирует 15
подтверждённых courtyard-коллизий, 67 screening-коллизий и один screening
mounting-конфликт в незаблокированной области. Подписанный электрический Review
A сохраняется, но placement и Review B заблокированы до полной электрически
ограниченной перерасстановки и строгого clearance PASS. Полный native source set PCB-MIC и
