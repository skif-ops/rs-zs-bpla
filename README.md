...
FL1/C64: строгий 2D clearance пройден, пост-SAW участок сокращён до 1.151 mm,
но comparative KiCad 9 DRC и независимая приёмка ещё открыты. Отдельно подготовлен ограниченный запрос для будущего
