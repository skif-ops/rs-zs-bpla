...
enum {
  ...
  ZS_CHAR_STATION_SECRETS = 0x0206,        /* v0.3: provisioning of the station secrets (write patch / read presence) */
...
#define ZS_BLE_BRIDGE_CACHE_SLOTS 8u   /* identity, config_read, installation_position, policy, session_role, station_secrets, status, gnss */
