...
CRITICAL_ASSIGNMENTS = {
    ...
    "CELL_PWRKEY_CMD": ("PD11", 58, "GPIO", "GPIO", "OUT"),
    "CELL_STATUS": ("PD13", 60, "GPIO", "GPIO", "IN"),
    "SIM_MUX_SEL": ("PE0", 97, "GPIO", "GPIO", "OUT"),
    "SIM_MUX_EN": ("PE2", 1, "GPIO", "GPIO", "OUT"),
    "SIM1_DET": ("PE3", 2, "GPIO", "GPIO", "IN"),
    "SIM2_DET": ("PE5", 4, "GPIO", "GPIO", "IN"),
