...
def main() -> None:
    ...
    require(by_id["U9"]["MPN"] == "MAX-M10S-00B", "GNSS module MPN mismatch")
    require(by_id["U9"]["Package"] == "LCC-18_9.7x10.1mm", "GNSS module package mismatch")
    require(by_id["J-RF-GNSS"]["MPN"] == "U.FL-R-SMT-1(60)", "GNSS RF connector MPN mismatch")
    require(by_id["U10"]["MPN"] == "E22-900M22S", "LoRa module MPN mismatch")
    require(by_id["U10"]["Package"] == "SMD_20x14_22P_1.27mm", "LoRa module package mismatch")
    require(by_id["J-RF-LORA"]["MPN"] == "U.FL-R-SMT-1(60)", "LoRa RF connector MPN mismatch")
    require(by_id["J-RF-CELL"]["MPN"] == "U.FL-R-SMT-1(60)", "cellular RF connector MPN mismatch")
    require(by_id["U12"]["MPN"] == "SDCIT2/32GB", "industrial microSD card MPN mismatch")
    require(by_id["J-SD1"]["MPN"] == "MEM2052-00-195-00-A", "microSD socket MPN mismatch")
    require(by_id["J-USB"]["MPN"] == "USB4105-GF-A-120", "USB-C connector MPN mismatch")
    require(by_id["J-USB"]["RefDes"] == "J11", "USB-C connector RefDes mismatch")
    require(by_id["J-TAMPER"]["MPN"] == "5040500291", "tamper header MPN mismatch")
    require(by_id["J-TAMPER"]["RefDes"] == "J13", "tamper header RefDes mismatch")
