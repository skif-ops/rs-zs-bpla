...
def main() -> int:
    ...
    require("HOST_SERVER_IMPLEMENTED; FIRMWARE_TARGET_PENDING" in icd,
            "ICD does not report the bounded implementation status")
    require("target subscribe/parser, Ed25519 downstream signature validation" in firmware_contract,
    ...
    print("scope: server envelope/retry/ACK + ACL; firmware target and hardware remain pending")
    return 0
