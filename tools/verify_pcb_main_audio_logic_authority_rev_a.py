...
def main() -> None:
    ...
    require(closed == {f"MAIN-AUTH-{index:03d}" for index in range(1, 10)}, "closed authority identity mismatch")
    require(open_ids == {f"MAIN-AUTH-{index:03d}" for index in range(10, 12)}, "remaining authority set mismatch")
