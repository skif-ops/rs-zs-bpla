...
CANDIDATE_SHA256 = "f24421e727595d754b7396fdc2941e5a7ac9265148d9ed80a8866c7852624591"
...
GENERATOR_SHA256 = "871ede881a241f8b78b76e1dc88426736a2afc27a5d8f361959e84513ac16b9b"
...
def audit(drc_base: Path | None = None, drc_candidate: Path | None = None) -> dict[str, object]:
    ...
    require(net_names[int(item.net)] == "VBAT_RAW" and
            ...
            math.isclose(math.dist(start, end), 5.946428, abs_tol=1e-6),
