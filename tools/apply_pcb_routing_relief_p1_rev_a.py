#!/usr/bin/env python3
"""PCB-MAIN placement-relief experiment P1 (ci-apply): pogo rows moved off U1, then the global session again.
...
OUT = ROOT / "hardware/kicad/candidates/PCB-ROUTING-P1"
INPUT, SES, LOG = OUT / "PCB-MAIN_ROUTE_INPUT_P1.dsn", OUT / "PCB-MAIN_ROUTED_P1.ses", OUT / "AUTOROUTE_P1.json"
STEM = "PCB-MAIN_RELIEF_P1_CANDIDATE_REV_A"
NAMESPACE = uuid.UUID("1f2e3d4c-5b6a-5978-8a9b-0c1d2e3f4a5b")
PASSES, TIME_LIMIT_S = 10, 170 * 60
MOVES = {"TP_EOL": ((33.0, 23.0), (47.5, 9.0)), "TP_CELL_DBG": ((47.0, 30.0), (22.5, 28.0))}
RIP_NETS = {"BOOT0"}
...
def main() -> int:
    if "--check" in sys.argv[1:]:
        ...
        print("PCB-MAIN relief P1: recorded")
        return 0
    g2.deps()
    assert sha256(BOARD) == BASE_SHA256
    OUT.mkdir(parents=True, exist_ok=True)
    info = route()
    summary = {"schema": "dioneya-pcb-main-relief-p1-v1", "measurement_only": True, "autoroute": info}
    if info["session_sha256"]:
        ...
        work = ROOT / "hardware/kicad/native/_rP1_cand"
