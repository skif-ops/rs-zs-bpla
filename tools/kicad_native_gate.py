...
def placement_candidate_audit(name: str) -> str | None:
    controls = {
        ...
        "PCB-PWR": (
            PCB_PWR_STATUS,
            "OPEN_F1_VALUE_ECO_LEGIBILITY_REMEDIATION_NATIVE_ERC_PDF_EVIDENCE_PENDING_HUMAN_REVIEW_PENDING_FITTED_2D_CLEARANCE_PRE_ROUTE_DIM_003_AND_STACKUP_REQUESTS_READY_ROUTING_PENDING",
