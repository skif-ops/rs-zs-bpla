...
`AudioAssembler`). Запись предыстории на плате — §5. Выгрузка по команде (выбор записей события, чанки, ACK),
серверный bridge и ACL, сквозной сценарий двойника — следующие шаги.
